    ...
    <DialogPortal>
      <DialogOverlay className="flex items-center justify-center p-4">
        <DialogPrimitive.Content
          ...
          className={cn(
            "relative z-50 grid w-full max-w-md gap-4 border bg-background p-6 shadow-lg rounded-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
            className
          )}
          {...props}
        >
